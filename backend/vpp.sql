...
INSERT INTO node_status_log (timestamp, relay_id, power_kw, soc) VALUES
...
-- bidding_log 더미 데이터
INSERT INTO bidding_log (timestamp, entity_id, bid_quantity_kwh, bid_price_per_kwh, llm_reasoning) VALUES
('2025-07-21 10:00:00', 1, 100, 120, '태양광 예측량이 높아 입찰 제안'),
('2025-07-21 10:00:00', 2, 50, 125, '풍력 상태 양호, 가격 경쟁력 있음'),
('2025-07-21 10:00:00', 3, 80, 130, '배터리 잔량 높음, 시장 반응 예상');
